...
hostBindings =
  ...
  , foreignBinding "divide-integer" (binary integer integer [failText] integer)
  ...
  , foreignBinding "divide-float" (binary float float [failText] float)
  ...
  , native "-" (binary integer integer [] integer)
  , native "-" (binary float float [] float)
  , native "÷" (binary integer integer [failText] integer)
  , native "÷" (binary float float [failText] float)
