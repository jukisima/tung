...
accepted =
  ...
  , ("algebraic data", "choose a option { none, a some };")
  , ("empty algebraic data", "choose 𝟘 {};")
  , ("parameterized effect", "deed a state { 𝟙 get: a, a set: 𝟙 };")
  ...
  , ("exported data", "show choose a option { none, a some };")
  ...
  , ("whole-module re-export", "show bring ground.tung;")
  ...
  , ("parenthesized local block", "(let x = 1; x + 2;)")
...
rejected =
  ...
  , ("choose requires a body", "choose option;")
...
expressions =
  ...
  , ("dollar keeps multiple parenthesized arguments separate", "a f $ if (a some) none", apply (EVar "if") [apply (EVar "f") [EVar "a"], apply (EVar "some") [EVar "a"], EVar "none"])
